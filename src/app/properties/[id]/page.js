  ...
  return (
    ...
    <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{property.name}</h1>
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            <h2 className="sr-only">Informções da Propriedade</h2>
            <p className="text-3xl tracking-tight text-gray-900">R$ {property.price}</p>
